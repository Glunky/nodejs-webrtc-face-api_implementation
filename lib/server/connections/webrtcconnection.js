...
class WebRtcConnection extends Connection {
  constructor(id, options = {}) {
    ...
    beforeOffer.call(this, peerConnection);
    ...
    this.doBroadcast = async broadcasted => {
      await broadcastStream(peerConnection, broadcasted);
    };
    ...
    Object.defineProperties(this, {
      ...
      stream: {
        get() {
          return peerConnection.getReceivers().map(receiver => receiver.track);
        }
      }
    });
  }
